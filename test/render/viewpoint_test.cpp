...
TEST_F (ViewpointTest, MatrixCalculations) {
    ...
    EXPECT_EQ(viewpoint->get_projection_matrix(), glm::mat4(1.0f));
    EXPECT_EQ(viewpoint->get_view_projection_matrix(), glm::mat4(1.0f));
    
    viewpoint->set_position(1.0f, 0.0f, 0.0f);
    EXPECT_EQ(viewpoint->get_view_matrix(), glm::translate(glm::vec3(1.0f, 0.0f, 0.0f)));
    EXPECT_EQ(viewpoint->get_view_projection_matrix(), glm::translate(glm::vec3(1.0f, 0.0f, 0.0f)));
    ...
    EXPECT_EQ(viewpoint->get_view_projection_matrix(), glm::translate(glm::vec3(1.0f, 0.0f, 0.0f)) * glm::perspective(1.0f, 4.0f / 3.0f, 1.0f, 2.0f));
}
